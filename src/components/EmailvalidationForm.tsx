    ...
    <form className="mt-7 flex flex-col gap-4 text-sm ">
      <div className="flex gap-5 pb-10">
        <input
          ...
          maxLength={1}
          type="number"
          className="remove-arrow text-center py-3 px-4 w-full border border-black-20 rounded focus-within:border-black-60 focus-within:outline-double focus-within:outline-2 focus-within:outline-black-20"
        />
        <input
